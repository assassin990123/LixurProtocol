...
*: Solve the double asking problem for wallet signup (More than one day at most)
*: Also, solve the perpetual sign-in problem
*: Might have to make people do Proof of Work on a transaction before it gets added to the graph. An option. (Not Urgent)
...
!: The two genesis transaction bug
